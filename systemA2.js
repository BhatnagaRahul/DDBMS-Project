...
// Connect to MongoDB
mongoose.connect('mongodb://127.0.0.1:27017/systemA2');
...
const PurchaseOrder = mongoose.model('systemA2collection', purchaseOrderSchema, 'systemA2collection');
...
app.post('/sendData', async (req, res) => {
  try {
    ...
    res.json({ message: 'Data sent successfully from System A2 to System B' });
  } catch (error) {
...
// Start the server
app.listen(port, () => {
  console.log(`System A2 is running on http://localhost:${port}`);
});
